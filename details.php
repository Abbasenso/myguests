                        ...
                        <div id="booking_advanced">
                            ...
                            <div class="row">
                                <form action="reginsert.php" method="post" class="booking_form_advanced">
                                    ...
                                    <input type="checkbox" value="">Kitchen </label>
                                    <label class="checkbox-inline">
                                    ...
                                    <input type="checkbox" value="">AC
                                     ...
                                     <label class="checkbox-inline">
                                    <input type="checkbox" value="">Kitchen Utilizes
                                    </label>
                                     <label class="checkbox-inline">
                                    <input type="checkbox" value="">Tea Pot
                                    </label>
                                    <label class="checkbox-inline">
                                    <input type="checkbox" value="">Bed Shoes
                                    </label>
                                    <label class="checkbox-inline">
                                    <input type="checkbox" value="">Smoking Allow
                                    </label>
                                    <label class="checkbox-inline">
                                    <input type="checkbox" value="">Drinking Allow
                                    </label>
                                     <label class="checkbox-inline">
